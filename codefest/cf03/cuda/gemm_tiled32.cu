%%writefile codefest/cf03/cuda/gemm_tiled32.cu
#include <cstdio>
#include <cstdlib>
...
__global__ void gemm_tiled32_kernel(const float *A, const float *B, float *C, int n) {
...
int main() {
    ...
    gemm_tiled32_kernel<<<gridDim, blockDim>>>(d_A, d_B, d_C, N);
